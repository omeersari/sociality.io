  ...
  <header>
    <div class="mobile-header">
      ...
      <div class="brand-name">
        <nuxt-link to="/">
          sociality<span style="font-weight: normal; color: #1f2226"
            >.io</span
          ></nuxt-link
        >
      </div>
      <div class="thumbnail-resp">
        <img src="~/assets/images/profile.jpeg" alt="" />
      </div>
    </div>
    <div :class="menuClicked ? 'showSidebar' : 'noShow'">
      <div class="menu">
        <div class="brands">
          <div
          ...
          <ul>
            ...
            <li v-for="item in accordionMenu" :key="item.id">
              <div class="menu-items" :class="item.active ? 'subMenu' : ''">
                <span
                  ><i :class="item.class" class="left"></i>
                  {{ item.name }}</span
                >
                <i
                  v-if="!item.active"
              ...
              <template v-if="activeSubMenu">
                ...
                >
                  <li
                    :class="[
                      activeSubElement === subItems ? 'activeSubItem' : '',
                    ]"
